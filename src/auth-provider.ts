  ...
  return {
    ...
    auth: [
      createProviderApiKeyAuthMethod({
        ...
        hint: "Bedrock API key (bearer token) for Stability AI image generation",
        ...
        wizard: {
          ...
          choiceHint: "Stability AI image generation on Amazon Bedrock",
          groupId: PROVIDER_ID,
          groupLabel: "Bedrock Images",
          groupHint: "Stability AI image generation on Amazon Bedrock",
